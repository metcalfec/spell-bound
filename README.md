<img src="https://cloud.githubusercontent.com/assets/17256216/15225235/634b2eaa-1832-11e6-8e3b-3cb0bb003665.png" width="90%"></img>
...
## Features
* A user can attempt to spell out a word that best matches the picture
* A user can view all completed words
* A user can achieve a streak count which activates new levels
* A user can spell varying words from three different difficulties
* A user can compete with friends on the leaderboard
